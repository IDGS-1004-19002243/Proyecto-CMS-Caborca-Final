...
/**
 * Editor CMS de responsabilidad ambiental.
 * Gestiona bloques narrativos, estadísticas, multimedia y contenido Shambhala.
 */
const EditarResponsabilidad = () => {
  const { success, error: toastError } = useToast();
  const { lang: idioma = 'es' } = useOutletContext();

  // Plantilla base para prevenir huecos de contenido en el editor.
  const defaultContent = {
    ...
    compania: {
      ...
      badge_ES: 'Empresa Socialmente Responsable', badge_EN: 'Socially Responsible Company',
      esrLabel_ES: 'Certificación', esrLabel_EN: 'Certification',
    ...
    energia: {
      ...
      badge_ES: 'Energía Limpia', badge_EN: 'Clean Energy',
    ...
    video: {
      badge_ES: 'Nuestro Compromiso', badge_EN: 'Our Commitment',
    ...
    pieles: {
      ...
      sustanciasLabel_ES: 'Sustancias eliminadas', sustanciasLabel_EN: 'Eliminated substances',
      ...
      freePercent_ES: '100%', freePercent_EN: '100%',
      freeText_ES: 'Libre de tóxicos', freeText_EN: 'Toxic free',
      image: 'https://blocks.astratic.com/img/general-img-landscape.png'
    },
    shambhala: {
      title_ES: 'Un lugar para renacer', title_EN: 'A place to be reborn',
      badge_ES: 'PROYECTO AGROECOLÓGICO', badge_EN: 'AGROECOLOGICAL PROJECT',
  ...
  // Inicializa el formulario de edición según la sección solicitada.
  function openEditor(section) {
    const data = content[section] || {};
    const dft = defaultContent[section] || {};

    setForm({
      title_ES: data.title_ES || data.title || dft.title_ES || dft.title || '', 
      title_EN: data.title_EN || dft.title_EN || '',
      badge_ES: data.badge_ES || data.badge || dft.badge_ES || dft.badge || '', 
      badge_EN: data.badge_EN || dft.badge_EN || '',
      esrLabel_ES: data.esrLabel_ES || dft.esrLabel_ES || '', 
      esrLabel_EN: data.esrLabel_EN || dft.esrLabel_EN || '',
      sustanciasLabel_ES: data.sustanciasLabel_ES || dft.sustanciasLabel_ES || '', 
      sustanciasLabel_EN: data.sustanciasLabel_EN || dft.sustanciasLabel_EN || '',
      subtitle_ES: data.subtitle_ES || data.subtitle || dft.subtitle_ES || dft.subtitle || '', 
      subtitle_EN: data.subtitle_EN || dft.subtitle_EN || '',
      p1_ES: data.p1_ES || data.p1 || dft.p1_ES || dft.p1 || '', 
      p1_EN: data.p1_EN || dft.p1_EN || '',
      p2_ES: data.p2_ES || data.p2 || dft.p2_ES || dft.p2 || '', 
      p2_EN: data.p2_EN || dft.p2_EN || '',
      highlight_ES: data.highlight_ES || data.highlight || dft.highlight_ES || dft.highlight || '', 
      highlight_EN: data.highlight_EN || dft.highlight_EN || '',
      image: data.image || dft.image || null,
      videoUrl: data.videoUrl || dft.videoUrl || '',
      description_ES: data.description_ES || data.description || dft.description_ES || dft.description || '', 
      description_EN: data.description_EN || dft.description_EN || '',
      sustanciasText_ES: data.sustanciasText_ES || data.sustanciasText || dft.sustanciasText_ES || dft.sustanciasText || '', 
      sustanciasText_EN: data.sustanciasText_EN || dft.sustanciasText_EN || '',
      freePercent_ES: data.freePercent_ES || data.freePercent || dft.freePercent_ES || '', 
      freePercent_EN: data.freePercent_EN || dft.freePercent_EN || '',
      freeText_ES: data.freeText_ES || data.freeText || dft.freeText_ES || '', 
      freeText_EN: data.freeText_EN || dft.freeText_EN || '',
      stat1_ES: data.stat1_ES || data.stat1 || dft.stat1_ES || dft.stat1 || '', 
      stat1_EN: data.stat1_EN || dft.stat1_EN || '',
      stat1Label_ES: data.stat1Label_ES || data.stat1Label || dft.stat1Label_ES || dft.stat1Label || '', 
      stat1Label_EN: data.stat1Label_EN || dft.stat1Label_EN || '',
      stat2_ES: data.stat2_ES || data.stat2 || dft.stat2_ES || dft.stat2 || '', 
      stat2_EN: data.stat2_EN || dft.stat2_EN || '',
      stat2Label_ES: data.stat2Label_ES || data.stat2Label || dft.stat2Label_ES || dft.stat2Label || '', 
      stat2Label_EN: data.stat2Label_EN || dft.stat2Label_EN || '',
      // shambhala
      missionTitle_ES: data.missionTitle_ES || data.missionTitle || dft.missionTitle_ES || '', 
      missionTitle_EN: data.missionTitle_EN || dft.missionTitle_EN || '',
      missionText_ES: data.missionText_ES || data.missionText || dft.missionText_ES || '', 
      missionText_EN: data.missionText_EN || dft.missionText_EN || '',
      granjaTitle_ES: data.granjaTitle_ES || data.granjaTitle || dft.granjaTitle_ES || '', 
      granjaTitle_EN: data.granjaTitle_EN || dft.granjaTitle_EN || '',
      granjaText_ES: data.granjaText_ES || data.granjaText || dft.granjaText_ES || '', 
      granjaText_EN: data.granjaText_EN || dft.granjaText_EN || '',
      educTitle_ES: data.educTitle_ES || data.educTitle || dft.educTitle_ES || '', 
      educTitle_EN: data.educTitle_EN || dft.educTitle_EN || '',
      educText_ES: data.educText_ES || data.educText || dft.educText_ES || '', 
      educText_EN: data.educText_EN || dft.educText_EN || '',
      statNumber_ES: data.statNumber_ES || data.statNumber || dft.statNumber_ES || '', 
      statNumber_EN: data.statNumber_EN || dft.statNumber_EN || '',
      statLabel_ES: data.statLabel_ES || data.statLabel || dft.statLabel_ES || '', 
      statLabel_EN: data.statLabel_EN || dft.statLabel_EN || '',
      statDesc_ES: data.statDesc_ES || data.statDesc || dft.statDesc_ES || '', 
      statDesc_EN: data.statDesc_EN || dft.statDesc_EN || '',
      thumb1: data.thumb1 || dft.thumb1 || '',
      thumb2: data.thumb2 || dft.thumb2 || ''
    });
  ...
  // Cierra panel lateral/modal de edición de sección.
  const closeEditor = () => {
    setActiveEdit(null);
  };
  ...
  // Persiste únicamente la sección activa para mantener cambios acotados.
  const saveChanges = async () => {
    ...
    try {
      ...
      const newSectionData = {
        ...
        esrLabel_ES: form.esrLabel_ES !== undefined ? form.esrLabel_ES : prevSection.esrLabel_ES,
        esrLabel_EN: form.esrLabel_EN !== undefined ? form.esrLabel_EN : prevSection.esrLabel_EN,
        subtitle_ES: form.subtitle_ES !== undefined && form.subtitle_ES !== '' ? form.subtitle_ES : (form.p1_ES !== undefined && activeEdit !== 'hero' && activeEdit !== 'shambhala' ? form.p1_ES : prevSection.subtitle_ES),
        subtitle_EN: form.subtitle_EN !== undefined && form.subtitle_EN !== '' ? form.subtitle_EN : (form.p1_EN !== undefined && activeEdit !== 'hero' && activeEdit !== 'shambhala' ? form.p1_EN : prevSection.subtitle_EN),
        ...
        freePercent_ES: form.freePercent_ES !== undefined ? form.freePercent_ES : prevSection.freePercent_ES,
        freePercent_EN: form.freePercent_EN !== undefined ? form.freePercent_EN : prevSection.freePercent_EN,
        freeText_ES: form.freeText_ES !== undefined ? form.freeText_ES : prevSection.freeText_ES,
        freeText_EN: form.freeText_EN !== undefined ? form.freeText_EN : prevSection.freeText_EN,
        sustanciasLabel_ES: form.sustanciasLabel_ES !== undefined ? form.sustanciasLabel_ES : prevSection.sustanciasLabel_ES,
        sustanciasLabel_EN: form.sustanciasLabel_EN !== undefined ? form.sustanciasLabel_EN : prevSection.sustanciasLabel_EN,
        // stats (energia)
  ...
  return (
    <div className="bg-white text-caborca-cafe font-sans pb-28">
      ...
      <main>
          ...
          <div className="w-full">
            <div className="w-full">
              <div className="relative overflow-hidden shadow-sm">
                <img src={content.hero.image} alt="Responsabilidad Ambiental Caborca Boots" className="w-full h-150 object-cover" />
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-3 mb-4">
                    ...
                    <span className="text-caborca-cafe font-bold tracking-wider text-sm uppercase">{idioma === 'es' ? content.compania.badge_ES || 'Empresa Socialmente Responsable' : content.compania.badge_EN || 'Socially Responsible Company'}</span>
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                    <img src={content.compania.image} alt="Responsabilidad Ambiental" className="w-full h-125 object-cover" />
                  </div>
                  <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl border border-gray-100">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-caborca-negro/60 uppercase tracking-wide">{idioma === 'es' ? content.compania.esrLabel_ES || 'Certificación' : content.compania.esrLabel_EN || 'Certification'}</div>
                    </div>
                  </div>
        ...
        <section data-cms-section="energia" className="py-24 bg-linear-to-br from-gray-50 to-white">
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="relative order-2 lg:order-1">
                  ...
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                    <img src={content.energia.image || "https://blocks.astratic.com/img/general-img-landscape.png"} alt="Paneles Solares" className="w-full h-125 object-cover" />
                  </div>
                ...
                <div className="space-y-6 order-1 lg:order-2">
                  <div className="inline-flex items-center gap-3 mb-4">
                    ...
                    <span className="text-caborca-cafe font-bold tracking-wider text-sm uppercase">{idioma === 'es' ? content.energia.badge_ES || 'Energía Limpia' : content.energia.badge_EN || 'Clean Energy'}</span>
                  </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-3 mb-4">
                  ...
                  <span className="text-white/80 font-bold tracking-wider text-sm uppercase">{idioma === 'es' ? content.video.badge_ES || 'Nuestro Compromiso' : content.video.badge_EN || 'Our Commitment'}</span>
                </div>
                ...
                <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10">
                  {content.video.videoUrl ? (
                    <iframe
                      ...
                      title="Responsabilidad Ambiental Caborca Boots"
                      frameBorder="0"
                    ...
                    <div className="w-full h-full relative">
                      <img src="https://blocks.astratic.com/img/general-img-landscape.png" alt="Fallback" className="w-full h-full object-cover opacity-50" />
                      <div className="absolute inset-0 flex flex-col items-center justify-center text-white gap-4 bg-black/20">
                        <svg className="w-16 h-16 opacity-60" fill="currentColor" viewBox="0 0 20 20">
                          <path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" />
                        </svg>
                        <span className="text-sm font-bold uppercase tracking-widest bg-black/40 px-4 py-2 rounded">Sin video: Se mostrará video por defecto</span>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                    <h4 className="font-semibold text-caborca-cafe mb-4 flex items-center gap-2">{idioma === 'es' ? content.pieles.sustanciasLabel_ES || 'Sustancias eliminadas' : content.pieles.sustanciasLabel_EN || 'Eliminated substances'}</h4>
                ...
                <div className="relative">
                  <div className="absolute -top-8 -left-8 w-full h-full bg-caborca-cafe/5 rounded-2xl"></div>
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                    <img src={content.pieles.image} alt="Pieles" className="w-full h-125 object-cover" />
                  </div>
                  <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl flex items-center gap-4">
                    ...
                    <div><div className="font-bold text-caborca-cafe">{idioma === 'es' ? content.pieles.freePercent_ES || content.pieles.freePercent || '100%' : content.pieles.freePercent_EN || content.pieles.freePercent || '100%'}</div><div className="text-xs text-gray-400 font-bold uppercase">{idioma === 'es' ? content.pieles.freeText_ES || content.pieles.freeText || 'Libre de tóxicos' : content.pieles.freeText_EN || content.pieles.freeText || 'Toxic free'}</div></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto text-center">
              <div className="inline-flex items-center gap-3 mb-4 justify-center">
                ...
                <span className="text-green-700 font-bold tracking-wider text-sm uppercase">{idioma === 'es' ? content.shambhala.badge_ES || 'PROYECTO AGROECOLÓGICO' : content.shambhala.badge_EN || 'AGROECOLOGICAL PROJECT'}</span>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-4">
                ...
                {activeEdit === 'compania' && (
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Etiqueta de sección (badge)</label>
                      {idioma === 'es' ? (
                        <input name="badge_ES" value={form.badge_ES} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      ) : (
                        <input name="badge_EN" value={form.badge_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Etiqueta ESR (debajo del logo)</label>
                      {idioma === 'es' ? (
                        <input name="esrLabel_ES" value={form.esrLabel_ES} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      ) : (
                        <input name="esrLabel_EN" value={form.esrLabel_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      )}
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Título</label>
                ...
                {activeEdit === 'pieles' && (
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Etiqueta sección "Sustancias eliminadas"</label>
                      {idioma === 'es' ? (
                        <input name="sustanciasLabel_ES" value={form.sustanciasLabel_ES} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      ) : (
                        <input name="sustanciasLabel_EN" value={form.sustanciasLabel_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      )}
                    </div>
                    <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input name={idioma === 'es' ? 'freePercent_ES' : 'freePercent_EN'} value={idioma === 'es' ? form.freePercent_ES : form.freePercent_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-700 mb-1">Texto libre tóxicos</label>
                        <input name={idioma === 'es' ? 'freeText_ES' : 'freeText_EN'} value={idioma === 'es' ? form.freeText_ES : form.freeText_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      </div>
                    </div>
                    <div className="bg-gray-50 p-3 rounded border flex gap-4 items-center">
                      <div className="flex-1">
                ...
                {activeEdit === 'video' && (
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-1">Badge (etiqueta superior)</label>
                      {idioma === 'es' ? (
                        <input name="badge_ES" value={form.badge_ES} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                      ) : (
                        <input name="badge_EN" value={form.badge_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe focus:outline-none" />
                ...
                {activeEdit === 'shambhala' && (
                  <div className="space-y-4 text-sm">
                    <div>
                      <label className="block font-semibold text-gray-700 mb-1">Etiqueta "PROYECTO AGROECOLÓGICO"</label>
                      <input name={idioma === 'es' ? 'badge_ES' : 'badge_EN'} value={idioma === 'es' ? form.badge_ES : form.badge_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe" />
                    </div>
                    <div className="grid md:grid-cols-2 gap-4">
                      {idioma === 'es' ? (
                        <>
                ...
                {activeEdit === 'energia' && (
                  <div className="space-y-4 text-sm">
                    <div>
                      <label className="block font-semibold text-gray-700 mb-1">Etiqueta de sección (badge)</label>
                      <input name={idioma === 'es' ? 'badge_ES' : 'badge_EN'} value={idioma === 'es' ? form.badge_ES : form.badge_EN} onChange={handleInput} className="w-full px-3 py-2 border border-gray-300 rounded focus:border-caborca-cafe" />
                    </div>
                    <div>
