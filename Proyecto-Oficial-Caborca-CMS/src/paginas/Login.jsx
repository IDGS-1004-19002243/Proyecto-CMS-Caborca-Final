...
/**
 * Pantalla de acceso del CMS.
 * Autentica, persiste sesión local y redirige al panel principal.
 */
export default function Login() {
  // Estado del formulario y feedback visual de autenticación.
  ...
  // Sincroniza inputs controlados y limpia mensajes de error al editar.
  ...
  // Ejecuta login contra API y guarda token/usuario en almacenamiento local.
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-caborca-beige-suave via-caborca-arena/30 to-caborca-beige-suave relative overflow-hidden">
        {/* Patrón decorativo */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-start p-12 w-full text-center">
          ...
          <div className="space-y-4 max-w-lg">
            <h2 className="font-serif font-bold text-4xl xl:text-5xl leading-tight text-caborca-negro">
              Sistema de Gestión
            </h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-linear-to-b from-caborca-beige-suave to-white">
        <div className="w-full max-w-md">
          ...
          {/* Encabezado */}
          <div className="mb-8">
            <h2 className="font-serif font-bold text-3xl text-caborca-negro mb-2">
