...
const Footer = () => {
  ...
  // Configuración de redes y visibilidad proveniente de ConfiguracionGeneral.
  ...
  // Teléfono principal para contacto rápido en el footer.
  const [telefono, setTelefono] = useState('');

  useEffect(() => {
    // Carga datos globales de sitio para render dinámico del pie de página.
  ...
  // Diccionario de labels de navegación y legales por idioma activo.
  const labels = {
    desc: language === 'es'
  ...
  // Solo muestra iconos marcados como visibles por configuración.
