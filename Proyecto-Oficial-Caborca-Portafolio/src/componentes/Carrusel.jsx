 ...
 * Consume slides del CMS y mantiene autoplay con fallback local.
 */
const Carrusel = () => {
  const { t } = useLanguage();
  ...
  // Mapea estructura API a estructura visual con traducción en tiempo real.
  ...
  // Configura autoplay y limpia intervalo al desmontar.
  useEffect(() => {
  ...
  // Navegación manual por dots con reinicio del temporizador.
