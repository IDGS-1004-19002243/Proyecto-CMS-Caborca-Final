...
/**
 * Página pública 404.
 * Usa contenido editable desde CMS con respaldo local.
 */
const NotFound = () => {
    const { t } = useLanguage();
    ...
    useEffect(() => {
        // Carga textos del recurso notfound y mezcla con defaults.
    ...
    return (
        <div 
            className="relative min-h-screen flex items-center justify-center font-sans overflow-hidden bg-[#0B0D11] bg-cover bg-center bg-no-repeat"
            style={content.imagenFondo ? { backgroundImage: `url('${getImageUrl(content.imagenFondo)}')` } : {}}
        >
