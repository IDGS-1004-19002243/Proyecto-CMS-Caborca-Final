...
/**
 * Página pública de catálogo de mujer.
 * Renderiza productos con filtrado y resolución de campos por idioma.
 */
const CatalogoMujer = () => {
  ...
  // Verifica si una propiedad cuenta con contenido válido.
  ...
  // Selección de texto por idioma activo con fallback neutral opcional.
  ...
  // Resultado final de catálogo tras aplicar estilo y orden.
                    ...
                    <div key={producto.id} className="group relative">
                      ...
                      <div className="mt-6 text-center">
                        <h3 className="text-xl font-serif font-bold text-caborca-cafe mb-1">
                          <Link to={`/producto/mujer/${producto.id}`}>{getProductText(producto, 'nombre')}</Link>
                        </h3>
